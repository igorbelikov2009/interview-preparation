...
var ClearString = function () {
    ...
    var foo = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.any([getSomeData(), getAnotherData(), getThirdData(), getFourthData()])];
                case 1:
                    result = _a.sent();
                    console.log(result);
                    return [2 /*return*/];
