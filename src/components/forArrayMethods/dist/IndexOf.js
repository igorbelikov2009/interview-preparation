...
var IndexOf = function () {
    ...
    var title = react_1.useState("Array.indexOf(item, from) - метод ищет item начиная с индекса from и возвращает номер индекса, на котором был найден искомый элемент, в противном случае -1, если он отсутствует.")[0];
    var descriptions = [
