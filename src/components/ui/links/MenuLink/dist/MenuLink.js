...
var MenuLink = function (_a) {
    ...
    if (isBackgroundWhite) {
        return (react_1["default"].createElement(react_router_dom_1.Link, __assign({ to: to, className: match ? MenuLink_module_scss_1["default"]["link-dark_active"] : MenuLink_module_scss_1["default"]["link-dark"] }, props), children));
    }
    return (react_1["default"].createElement(react_router_dom_1.Link, __assign({ to: to, className: match ? MenuLink_module_scss_1["default"]["link-light_active"] : MenuLink_module_scss_1["default"]["link-light"] }, props), children));
};
