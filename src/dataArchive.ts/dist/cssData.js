...
exports.arrayCSS = [
    ...
    },
    {
        ...
        answer: [
            ...
            "Вот примеры: ",
            " ",
            "1. Любой элемент <a>, на который пользователь наведёт указатель мыши, будет окрашен в цвет. ",
            " ",
            "      a:hover { ",
            "            color: green;",
            "      } ",
            " ",
            "2. Выбирает все посещённые элементы <a> и окрашивает их в цвет purple.  ",
            "      a:visited { ",
            "            color: purple;",
            "      } ",
        ],
