...
var BrowserLinksDirectory = function () {
    var links = [
        {
        ...
        },
        {
            ...
            title: "Таблица HTML-мнемоники. Символы валют. Различные символы. Знаки препинания. Кавычки. Дроби. Математические символы. Греческие буквы. Латинские буквы. Стрелки "
        },
        {
            href: "https://www.wm-school.ru/tags/symbols.html",
            title: "Специальные символы HTML.  Кавычки, пунктуация, математические знаки. Звездочки, снежинки, номера, карандаши. Стрелки. Карточные масти. Знаки валют. Знаки зодиака. Греческий алфавит.  "
        },
        {
    ...
    return (react_1["default"].createElement("div", null,
        react_1["default"].createElement(PageLink_1["default"], { links: links, title: "\u0421\u0441\u044B\u043B\u043A\u0438 \u043D\u0430 \u0441\u043F\u0440\u0430\u0432\u043E\u0447\u043D\u0438\u043A\u0438, \u0434\u0438\u0440\u0435\u043A\u0442\u043E\u0440\u0438\u0438" })));
};
exports["default"] = BrowserLinksDirectory;
