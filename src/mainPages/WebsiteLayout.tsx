...
const WebsiteLayout = () => {
  ...
  const ArrayHeadingAnswers: IObjectHeadingAnswers[] = [
    ...
    {
      heading:
        "Основные техники реализации сайтов под любое разрешение. Максимальные и минимальные размеры компонентов",
      answer: [
  ...
  return (
    <div>
      <PageLink links={links} title="Вёрстка вэб-сайтов, ссылки" />
      <Page title="Вопросы по вёрстке вэб-сайтов" ArrayHeadingAnswers={ArrayHeadingAnswers} />
    </div>
  );
};
