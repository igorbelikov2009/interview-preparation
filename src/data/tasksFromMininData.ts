...
export const arrayTasksFromMinin: IObjectTasks[] = [
  ...
  {
    heading: "Плоский массив. Распакавать (развернуть) и отсортировать вложеные массивы в один массив.",
    href: "https://www.youtube.com/watch?v=x-EZy6gu_38",
    taskCode: [
      "Метод flat()создает новый массив со всеми элементами подмассива, объединенными в него рекурсивно до указанной глубины. ",
      " ",
      "Это очень плохое решение задачи!!!!!!!!!!!!!!!!! Надо рещать как здесь:",
      "https://www.youtube.com/watch?v=3QZFHgCiX70&list=PLPiq_hi6UrQoIZVVTsHsadUmdMCve5Qdx&index=31",
      " ",
      ...
      "console.log(flatten([[3, 2, 1], [4, 6, 5], [], [9, 7, 8]])); // [1, 2, 3, 4, 5, 6, 7, 8, 9]",
