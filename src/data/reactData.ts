...
export const arrayReact: IObjectHeadingAnswers[] = [
  ...
  {
    heading:
      "Назовите разницу между контролируемым (управляемым) и неконтролируемым (неуправляемым) компонентом (Кратко.......) ",
    answer: [
  ...
  {
    heading:
      "В чем разница между управляемыми (контролируемым) и не управляемыми (неконтролируемым) компонентами? (Подробно, с примером...) ",
    answer: [
