...
export const arrayTypescript: IObjectHeadingAnswers[] = [
  ...
  },
  {
    ...
    answer: [
      "1. Тип (данных) — это характеристика поведения данных, определение их значений и видов операций, которые могут быть выполнены над этими данными.",
      ...
      "-*-",
      "2. Система типов в TypeScript разделена на четыре основных раздела:",
      "2.1. Any - специальный тип, который может использоваться для отключения проверки типов.",
