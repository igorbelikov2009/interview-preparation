...
export const arrayTypescript: IObjectHeadingAnswers[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      "3. Void - отсутствие конкретного типа. Тип данных Void можно назвать полной противоположностью типа any, так как этот тип означает отсутствие конкретного типа. Основное предназначение типа Void — явно указывать на то, что у функции или метода отсутствует возвращаемое значение.",
  ...
  },
  {
    ...
    answer: [
      "Рекомендуется применять строгое равенство ‘===’, или строгое неравенство !== null, для проверки как на undefined, так и null. Так же оператор нулевого слияния ‘??’ помогает выполнить эту проверку. ",
      " ",
