...
export const arrayTypescript: IObjectHeadingAnswers[] = [
  ...
  },
  {
    ...
    answer: [
      "TypeScript предоставляет набор встроенных типов, которые можно использовать для облегчения преобразования типов данных в коде.",
  ...
  },
  {
    ...
    answer: [
      ...
      "} */",
      "-*-",
      "Пример 2: ''Сделайте все свойства в T необязательными через дженерик.''",
  ...
  },
  {
    ...
    answer: [
      ...
      "} */",
      "-*-",
      "Пример 3: ''Сделайте все необязательные свойства в T обязательными  через дженерик.''",
      "Дженерик с обобщённым типом Т:",
      "type Required<T> = {",
      "- - [P in keyof T]-?: T[P];",
      "};",
  ...
  },
  {
    ...
    answer: [
      ...
      "} */",
      "-*-",
      "Пример 2: ''Сделайте все свойства в T неизменными, доступными только чтения через дженерик.''",
      "Дженерик с обобщённым типом Т:",
  ...
  },
  {
    ...
    answer: [
      ...
      "}",
      "-*-",
      "Пример 3. Создадим объектный тип с двумя свойствами, используя интерфейс объекта с четырьмя свойствами через дженерик.",
      "Дженерик с обобщённым типом Т:",
      "type Pick<Type, Keys> = {",
      "- - [P in K]: T[P];",
      "};",
  ...
  },
  {
    ...
    answer: [
      ...
      "-*-",
      "Пример 2. Из исходного исключаем свойства 'password' и 'phone', используя утилиту Omit<Type, Keys>.",
      "Имеем исходный тип объекта User ",
      "type User = {",
      "- name: string;",
      "- password: string;",
      ...
      "- address: string;",
      "-*-",
      "Пример 3. Из исходного исключаем свойства 'password' и 'phone', используя утилиту Omit<Type, Keys> через дженерик. ",
      "Дженерик с обобщённым типом Т:",
  ...
  },
  {
    ...
    answer: [
      "Создает тип, исключая из UnionType все члены объединения, которые можно присвоить ExcludedMembers .",
      "",
      "",
      "",
      "",
