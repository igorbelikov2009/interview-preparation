...
exports.arrayNumberMethods = exports.linksNumberMethods = void 0;
exports.linksNumberMethods = [
    {
...
exports.arrayNumberMethods = [
    ...
    {
        heading: "Проверка isNaN() - это глобальный метод проверки на NaN с учетом приведения указанного типа данных к числу: ",
        answer: [
