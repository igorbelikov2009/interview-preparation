...
exports.arrayLocalStorage = exports.linksLocalStorage = void 0;
exports.linksLocalStorage = [
    {
...
exports.arrayLocalStorage = [
    ...
    },
    {
        ...
        answer: [
            "Файлы cookie: файлы cookie это небольшой пакет данных, которые хранятся в браузере пользователя и могут быть доступны веб-сайту при последующих посещениях.",
            "Важная особенность у файлов cookie:",
            "1. Файлы cookie имеют время жизни, которое мы сами можем устанавливать.",
            "2. С каждым запросм на сервер у нас эти куки отправляются автоматически и сервер может эти куки так же переписать. ",
