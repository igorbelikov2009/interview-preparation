...
exports.arrayInterviews = [
    ...
    },
    {
        ...
        answer: [
            "Основное различие: ",
            "CSS служит для оформления страниц. Поэтому все картинки, которые являются частью этого самого оформления должны быть вынесены в CSS. Картинки, которые относятся к содержанию страниц вставляем тегом <img>. ",
            ...
            "  5. Использование imgвместо background-imageможет значительно улучшить производительность анимации по сравнению с фоном.",
            " ",
