...
exports.arrayJavascript = [
    ...
    },
    {
        ...
        answer: [
            "Промис — это объект JavaScript, который занимается обработкой асинхронного кода. Промис представляет результат успешного или неудачного завершения асинхронной операции. ",
            " ",
            "Промисы позволяют откладывать блоки кода до момента выполнения или отклонения действия. Вместо передачи обратных вызовов в функцию они прикрепляются к концу промиса, обеспечивая лучшую читаемость и возможность применения цепочек. ",
