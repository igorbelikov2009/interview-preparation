...
exports.arrayJavascript = [
    ...
    {
        heading: "Преобразование промисов в asynk / await через Promise.all(promises)  ",
        answer: [
    ...
    {
        heading: "Создание цепочки промисов:",
        answer: [
            "1. Создаём функции с промисами getSomeData() и getAnotherData() :",
            "      const getSomeData: () => Promise<string> = () => { ",
            "            const promise: Promise<string> = new Promise((resolve) => {",
            ...
            "      }; ",
            " ",
            "2. Создаём цепочку вызовов:",
            "      getSomeData().then((res) => { ",
            "            console.log(res);",
            " ",
            "            getAnotherData().then((res) => {",
            "                  console.log(res);",
            "            });",
            "      });  ",
            "      // some data ",
            "      // another ",
            " ",
            "3. Преобразуем промисы в asynk / await",
            "      const foo = async () => { ",
            "            try { ",
            "                  const res = await getSomeData();",
            "                  const res2 = await getAnotherData();",
