...
exports.arrayJavascript = [
    ...
    {
        heading: "Промисы (Promise) создаются.",
        answer: [" ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " ", " "],
        isParagraph: true
    },
    {
    ...
    {
        heading: "Event loop - событийный цикл: микрозадачи и макрозадачи (***)",
        answer: [
            "    Блоки синхронного кода всегда выполняются последовательно сверху вниз. Важно: синхронный код выполняется в том порядке, в котором он был вызван.",
    ...
    {
        heading: "Call stack -  стек вызовов. ",
        answer: [
