...
exports.linksJavascript = [
    ...
    },
    {
        ...
        title: "Шпаргалка по Axios | MyJavaScript"
    },
    {
    ...
    {
        href: "https://www.freecodecamp.org/news/axios-react-how-to-make-get-post-and-delete-api-requests/ ",
        title: "Axios React — как получать, публиковать и удалять запросы API "
    },
    {
    ...
    {
        href: "https://habr.com/ru/companies/usetech/articles/729434/",
        title: "Клонирование объектов JS"
    },
    {
        href: " ",
        title: " "
...
exports.arrayJavascript = [
    {
        ...
        answer: [
            ...
            "      JavaScript имеет динамическую типизацию. Это значит, что нам не нужно определять тип переменной заранее. Тип определится автоматически во время выполнения программы. Также это значит, что мы можем использовать одну переменную для хранения данных различных типов: ",
            "      -  foo 42// сейчас foo типа Number ",
            "      -  foo 'bar'// а теперь foo типа String ",
            "      -  foo true// foo становится типа Boolean. ",
            "В статически типизированном языке тип проверяется во время компиляции. Другими словами, переменные JavaScript не связаны с типом. Это означает, что вы можете без проблем изменить тип данных. ",
            " ",
    ...
    },
    {
        ...
        answer: [
            "      Поднятие — подъем переменной или функции в верхнюю часть текущей области видимости. В результате переменной можно воспользоваться до её объявления. Поднимаются лишь объявления переменных, но не код их инициализации.",
            ...
            " ",
            "      В фазе компиляции функциональные выражения и переменные, объявленные с помощью ключевого слова «var», со значением undefined поднимаются в самый верх текущей области видимости (как бы перемещаются в начало нашего кода. Это объясняет, почему мы можем вызывать функции до их объявления — прим. пер.). ",
    ...
    },
    {
        ...
        answer: [
            "Замыкание — это комбинация функции и лексического окружения, в котором эта функция была определена. Другими словами, замыкание даёт доступ к Scope (области видимости) внешней функции из внутренней функции. В JavaScript замыкания создаются каждый раз при создании функции, во время её создания. ",
            "Любая функция, независимо от места выполнения, имеет доступ к переменным из ее лексической области видимости, в этом суть замыканий.",
            "Пример замыкания: ",
            "      function makeFunc() {",
            "            var name = 'Mozilla';",
            ...
            " ",
            "Если обобщить: ",
            "*    Каждая функция при создании получает ссылку [[область видимости]] на объект с переменными, в контексте которого была создана (внутренняя среда этой функции). ",
            "*    При запуске функции создаётся новый объект с переменными 'лексическое окружение'. Он получает ссылку на внешний объект переменных из [[область видимости]] ",
            "*    При поиске переменных он осуществляется сначала в текущем объекте переменных, а потом – по этой ссылке. ",
            "Выглядит всё настолько просто: «Функция читает переменные снаружи» – и всё.",
        ],
        isParagraph: true
    },
    {
    ...
    },
    {
        ...
        answer: [
            ...
            " ",
            "1. У этого функции - объекта нет свойства 'hello': ",
            "      function Yo() {",
            "            // внутри создаётся новый объект, ссылка на который - this  ",
            "            this.name = 'Dima'; ",
            "            // return this",
            "      } ",
            " ",
            "2. Через prototype мы добавляем нашей функции-объекту свойство 'hello': ",
            "      Yo.prototype.hello = function () { ",
            "            alert('hello') ",
            "      } ",
            " ",
            "3. Через конструктора: ",
            "      var yo = new Yo() ",
            "Наш yo обладает неймом, потому, что нейм есть в 1*: ",
            "      yo.name ",
            "Так же он может говорить hello. Мы этот hello засунули через прототип 2*: ",
            "      yo.hello(); ",
            " ",
            "Мы можем создать кучу объектов через конструктор new Yo() и у всех них будет свойство hello(). Все они будут юзать не свой личный hello(), а тот hello(), который мы засунули через прототип.",
            "-*-",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "Прототип - это объект. Прототипом объекта А называется объект B, свойства и методы которого доступны для объекта A как собственные.",
            "У любого объекта есть прототип, на который указывает его свойство __proto__ и который также является объектом.",
            "У любой функции есть прототип, на который указывает свойство prototype.  ",
            "Прототип - это контейнер, в котором сложены свойства и методы для работы с определенным классом объектов. Такой контейнер автоматически становится прототипом объектов, создаваемых функциями-конструкторами",
    ...
    },
    {
        ...
        answer: [
            ...
            "Ссылки, связанных друг с другом объектов, образуют прототипную цепочку, которая лежит в основе прототипного наследования.   ",
            " ",
            "const o = {} ",
    ...
    },
    {
        ...
        answer: [
            ...
            " ",
            "Из-за того, что все примитивные значения хранятся в небольшом и фиксированном количестве байт, операции над ними выполнять несложно. Такие типы данных называют примитивными. ",
            " ",
            ...
            "      myData   ---> { те же надра памяти } <---   yourData. ",
            " ",
            ...
            " ",
            "Но не стоит забывать, что никакого сравнения по значениям не будет, даже если мы создадим объекты с абсолютно одинаковыми свойствами и значениями. ",
            "",
            "      const cat = { name: 'Феликс' };",
            "      const dog = { name: 'Феликс' };",
            "      console.log(cat === dog); // false  -  эти объекты не равны другу другу",
            " ",
            ...
            "Если нужно безопасно модифицировать объект, то для начала придётся его скопировать. Скопировать объект можно: через Object.assign() или используя спред-синтаксис ... ",
            "",
            "      interface IAdmin {",
            ...
            "      }; ",
            " ",
            "    ***  Поверхностное копирование, то есть копирование без включения вложенных объектов или массивов. ",
            " ",
            "3.1. Чтобы создать «реальную копию» (клон), можно использовать Object.assign():",
            "      const adminCopy = Object.assign({}, admin); ",
            "      console.log(adminCopy); // {name: 'Анна', age: 21, isAdmin: true}",
            " ",
            "3.2.  Чтобы создать «реальную копию» (клон), можно использовать  спред-синтаксис ... ",
            "      const anotherCopy = { ...admin };  ",
            "      console.log(anotherCopy); // {name: 'Анна', age: 21, isAdmin: true} ",
            " ",
            "3.3. Чтобы создать «реальную копию» (клон), можно создать пустой объект и скопировать в него все свойства admin",
            "let clone: IAdmin = {}; ",
            " ",
            ...
            "      } ",
            " ",
            "      console.log(clone); // {name: 'Анна', age: 25, isAdmin: true }",
            " ",
            "3.4.  Вложенное клонирование. structuredClone(obj) позволяет клонировать бесконечно вложенные объекты и массивы, циклические ссылки, широкий спектр типов JavaScript, таких как: Date, Set, Map, Error, RegExp, ArrayBuffer, Blob, File, ImageData и многие другие.",
            "      let user = { ",
            "            name: 'John',",
            "            sizes: {",
            "                  height: 182,",
            ...
            "      }; ",
            " ",
            "Выполяем вложенное клонирование: ",
            "      let copyUser = structuredClone(user); ",
            " ",
            "Меняем отдельные свойства у объектов и выводим их значения в консоль ",
            "      copyUser.sizes.height = 200; ",
            "      console.log(copyUser.sizes.height); // 200 ",
            " ",
            "      user.sizes.height = 150; ",
            "      console.log(user.sizes.height); // 150 ",
            " ",
            "С помощью structuredClone(obj) мы избежали мутации объектов. ",
            " ",
        ],
        isParagraph: true
    },
    {
        heading: "Ссылочные типы данных. Поверхностное и вложенное клонирование (глубокое копирование) объектов, мутации и неизменяемость.",
        answer: [
            ...
            "      }; ",
            " ",
            "2. Поверхностное копирование, то есть копирование без включения вложенных объектов или массивов. ",
            " ",
            "2.1. Чтобы создать «реальную копию» (клон), можно использовать Object.assign():",
            "      const adminCopy = Object.assign({}, admin); ",
            "      console.log(adminCopy); // {name: 'Анна', age: 21, isAdmin: true}",
            " ",
            "2.2.  Чтобы создать «реальную копию» (клон), можно использовать  спред-синтаксис ... ",
            "      const anotherCopy = { ...admin };  ",
            "      console.log(anotherCopy); // {name: 'Анна', age: 21, isAdmin: true} ",
            " ",
            "2.3. Чтобы создать «реальную копию» (клон), можно создать пустой объект и скопировать в него все свойства admin",
            "      let clone: IAdmin = {}; ",
            " ",
            "      for (let key in admin) { ",
            "            clone[key] = admin[key];",
            ...
            "      console.log(clone); // {name: 'Анна', age: 25, isAdmin: true }",
            " ",
            "!!! Чтобы сделать глубокое клонирование используя цикл клонирования и проверяя каждое значение admin[key] в Typescript нам придётся исходному объекту и его клону присвоить тип 'any'. То есть отключить проверку типов для этих объектов. ",
            " ",
            "3.  Вложенное клонирование (глубокое копирование) позволяет клонировать бесконечно вложенные объекты и массивы, циклические ссылки, широкий спектр типов JavaScript, таких как: Date, Set, Map, Error, RegExp, ArrayBuffer, Blob, File, ImageData и многие другие.",
            "3.1. structuredClone(obj) ",
            "      let user = { ",
            "            name: 'John',",
            "            sizes: {",
            "                  height: 182,",
            ...
            "            },",
            "      }; ",
            "Выполняем вложенное клонирование: ",
            "      let copyUser = structuredClone(user); ",
            " ",
            "Меняем значения свойств объекта и выводим в консоль: ",
            "      copyUser.sizes.height = 200; ",
            "      console.log(copyUser.sizes.height); // 200 ",
            "",
            "      user.sizes.height = 150; ",
            "      console.log(user.sizes.height); // 150 ",
            "",
            "С помощью structuredClone(obj) мы избежали мутации вложенных объектов. ",
            " ",
            "3.2.  Используя методы JSON.parse() и JSON.stringify(): ",
            "      const admin = { ",
            "             name: 'Anna',",
            "             age: 21,",
            "             isAdmin: true,",
            ...
            "",
            "Используя методы JSON.parse() и JSON.stringify() мы избежали мутации вложенных объектов.  ",
            "Этот трюк удивительно производительный, но имеет некоторые недостатки: объект Date получаем строкой. ",
        ],
        isParagraph: true
    },
    {
        heading: "В чем разница когда данные присваиваются по ссылке или по значению?",
        answer: [
            "Когда по значению - это значит, что переменной присваивается значение, и при обращении к ней - мы будем получать её конкретное значение. Мы сможем его поменять, когда нам это будет нужно.",
            "Когда по ссылке - это значит, что мы присваиваем переменной ссылку, например на объект. И если мы потом захотим поменять значение в этой переменной, то мы можем потерять ссылку на тот объект (если нигде в другом месте мы не присваивали ещё какой-нибудь переменной эту ссылку) ",
        ],
        isParagraph: true
    },
    {
        heading: "Какие данные присваиваются по ссылке а какие по значению?",
        answer: ["Объекты, массивы по ссылке. Всё остальное по значению. "],
        isParagraph: true
    },
    {
        heading: "Почему, если сравнить два одинаковых объекта они не будут равны?",
        answer: [
            "Если эти 2 объекта имеют одну и ту же ссылку (просто одна переменная присвоилась второй), то они будут равны.",
            "Если это 2 одинаковых объекта, но с разными ссылками - они никогда не будут равны. ",
        ],
        isParagraph: true
    },
    {
        heading: "Как проверить что значение является функцией?",
        answer: ["typeof(foo) === 'function'"],
        isParagraph: true
    },
    {
        heading: "“Undefined” примитивный тип - значение которого неопределённо. ",
        answer: [
            "Если переменная объявлена, но ей не присвоено никакого значения, то её значением будет undefined. Undefined используется, чтобы обозначить неизвестное или неопределённое значение.",
            "-*-",
    ...
    },
    {
        ...
        answer: [
            ...
            "      console.log(typeof 'John Abraham'); // string",
    ...
    },
    {
        ...
        answer: [
            ...
            "    -  null означает, что значение есть и оно равно null - «значение отсутствия значения», то есть: явное указание пустоты. null — это значение, которое присваивается переменной явно.",
    ...
    },
    {
        ...
        answer: [
            "1. null — это «значение отсутствия значения». null — это значение, которое присваивается переменной явно, явное указание пустоты..",
    ...
    {
        heading: "Объясните разницу между методами forEach() и map().",
        answer: [
            "1. Основное различие между .forEach() и .map() заключается в том, что .map() возвращает новый массив. Если вам нужно получить результат преобразования элементов исходного массива, не меняя этот массив, тогда стоит выбрать .map(). Если же нужно просто перебрать элементы массива — тогда можно воспользоваться .forEach().",
            "            .forEach() перебирает массив и изменяет его.",
            "            .map() создает копию массива и изменяет копию.",
            " ",
            "2. Вот как работает .forEach():",
            "    *  .forEach() перебирает элементы массива.",
            "    *  .forEach() выполняет переданную ему функцию обратного вызова для каждого элемента массива.",
            ...
            " ",
            "3. Вот краткая характеристика метода .map():",
            "    *  .map() перебирает элементы массива.",
            "    *  .map() преобразует каждый элемент исходного массива в элемент нового массива, вызывая переданную ему функцию для каждого элемента исходного массива.",
            "    *  .map() создает копию массива и изменяет копию.",
            " ",
            "3.1. Пример:",
    ...
    },
    {
        ...
        answer: [
            "1. for() - для перебора элементов массива, символов строк по цифровым индексам.",
    ...
    },
    {
        ...
        answer: [
            "Оператор break прерывает выполнение цикла и продолжает выполнение кода вне цикла. ",
            " ",
            "      for (var i = 0; i < 100; i++) {  ",
            "            if (i === 5)  ",
            "            { break; } ",
    ...
    },
    {
        ...
        answer: [
            "Оператор continue позволяет пропустить текущую итерацию цикла, не прерывая его полностью, и перейти к следующей.",
            " ",
            "      for (var i = 0; i < 5; i++) { ",
            "            if (i === 2 || i === 3) ",
            "            { continue; } ",
    ...
    },
    {
        ...
        answer: [
            "Оператор new используется в функциях-конструкторах для создания нового объекта .",
    ...
    },
    {
        ...
        answer: [
            "«==» нестрогая проверка на равенство используется для сравнения двух значений независимо от типа данных переменной (сравнивает значения).",
            "«===» строгая проверка на равенство используется для сравнения двух значений, но это будет строгая проверка, поэтому будет проверяться соответствие значения и типа данных (сравнивает как значение, так и тип).",
        ],
        isParagraph: true
    },
    {
    ...
    },
    {
        ...
        answer: [
            "Функция isNaN() определяет, является ли значение не числом, но при использвании Typescript выдаёт ошибку на проверке нечисловых значений. Поэтому создадим новую функцию:",
            " ",
            "      const isNumeric = (val: string | Object): boolean => { ",
            ...
            "      }; ",
            " ",
            "      console.log(isNumeric(admin)); // false ",
            "      console.log(isNumeric('adminCopy')); // false ",
    ...
    },
    {
        ...
        answer: [
            "11 способов преобразования строки в число с помощью JavaScript.",
            " ",
            "    -  используя Number() функцию ",
            "    -  используя parseInt() функцию ",
            "    -  используя унарный оператор plus (+) ",
            "    -  умножение строки на число 1 ",
            "    -  разделив строку на число 1 ",
            "    -  вычитание числа 0 из строки ",
            "    -  используя побитовый оператор NOT (~) ",
            "    -  используя Math.floor() функцию ",
            "    -  используя Math.ceil() функцию ",
            "    -  используя Math.round() функцию",
            " ",
            "1. Функция Number() преобразует строку в число. Это может быть целое число или десятичное число. Они часто могут быть менее безопасными, чем использование parseInt или parseFloat.",
            " ",
            "2. Функция parseInt() преобразует строку в целое число: ",
            " ",
            "      parseInt('30', 10) // 30 ",
            "      parseInt('55px', 10) // 50  ",
            "      parseInt(2.55, 10) // 2",
            " ",
            "3. Функция parseFloat() преобразует строку в число точек (с десятичным числом). ",
            "      ",
            "      parseFloat('30') // 30 ",
            "      parseFloat('55px') // 50 ",
            " ",
            "4. Оператор унарного плюса (+) преобразует строку в число. Оператор будет предшествовать операнду. ",
            " ",
            "      const quantity = '12'; ",
            "      console.log(+quantity); // 12 ",
            " ",
            "Мы также можем использовать оператор унарного плюса (+) для преобразования строки в число с плавающей запятой. ",
            " ",
            "      const quantity = '12.99';",
            "      console.log(+quantity); // 12.99",
            " ",
            "5. Другой способ преобразовать строку в число - использовать базовую математическую операцию. Вы можете умножить строковое значение на 1, и оно вернет число.  JavaScript преобразует наше строковое значение в число, а затем выполняет эту математическую операцию. Если строка не может быть преобразована в число, то математическая операция не будет работать, и она вернет NaN. Этот метод также будет работать для чисел с плавающей запятой.",
            " ",
            "      const quantity = '12'; ",
            "      console.log(quantity * 1); // 12 ",
            " ",
            "6. Вместо умножения на 1, вы также можете разделить строку на 1. JavaScript преобразует наше строковое значение в число, а затем выполняет эту математическую операцию.",
            " ",
            "      const quantity = '10.5'; ",
            "      console.log(quantity / 1); // 10.5",
            " ",
            "7. Другим методом было бы вычесть 0 из строки. Как и раньше, JavaScript преобразует наше строковое значение в число, а затем выполняет эту математическую операцию.",
            " ",
            "      const quantity = '19'; ",
            "      console.log(quantity - 1); // 19",
            " ",
            "8. Если мы используем один побитовый оператор NOT (~) для числа, то он выполнит эту операцию: -(x + 1) ",
            " ",
            "      console.log(~19); // -20",
            " ",
            "Использование двух побитовых операторов NOT (~~)  преобразует нашу строку в число. ",
            " ",
            "      const quantity = '19'; ",
            "      console.log(~~quantity); // 19",
            " ",
            "      Этот метод не будет работать для чисел с плавающей запятой, потому что результатом будет целое число.",
            "      Если бы вы попытались использовать этот метод для нечисловых символов, то результат был бы нулевым.",
            " ",
            "9. Функция Math.floor() округлит число в меньшую сторону до ближайшего целого числа.",
            " ",
            "      const quantity = '13.4'; ",
            "      console.log(Math.floor(quantity)); // 13",
            " ",
            "      Если мы попытаемся использовать нечисловые символы, то результатом будет NaN. ",
            " ",
            "      const quantity = 'awesome'; ",
            "      console.log(Math.floor(quantity)); // NaN ",
            " ",
            "10. Функция Math.ceil() округлит число до ближайшего целого.",
            " ",
            "      const quantity = '7.18';",
            "      console.log(Math.ceil(quantity)); // 8 ",
            " ",
            "11. Функция Math.round() округлит число до ближайшего целого. ",
            " ",
            "      const quantity = '6.3'; ",
    ...
    },
    {
        ...
        answer: [
            "Массивом называется упорядоченный тип данных, хранящий несколько значений. Это означает, что каждый элемент в массиве имеет числовой идентификатор (индекс), который используется для ссылки на его место в массиве.",
    ...
    },
    {
        ...
        answer: [
            ...
            "Значение по умолчанию - это значение, которое функция будет использовать в случае, если функция вызвана без аргументов, или если параметру явным образом передано значение undefined.. ",
            " ",
            "*      Устанавливаем значение параметра функции по умолчанию b = 1: ",
            " ",
            ...
            " ",
            "*      Здесь параметр b не определён, поэтому передаётся значение 1, установленный по умолчанию:",
            " ",
    ...
    },
    {
        ...
        answer: [
            "Spread-оператор дает доступ к внутренним составляющим частям итеративного объекта (массивы, коллекции Map, объектные литеры).",
            "Оператор Spread позволяет расширять итерируемые объекты (массивы/коллекции Map/объектные литеры/строки) до отдельных аргументов/элементов.",
            " ",
            " Рассмотрим базовые задачи, в которых он может быть полезен: ",
            "1. Дублирование итерируемых объектов. Spread-оператор – один из лучших способов дублировать итерируемый объект.",
            " ",
            "      const foo = [ 'hello', 'bonjour', 'konnichiwa' ]; ",
            "      const bar = [ ...foo ];",
            "      console.log(bar); // [ 'hello', 'bonjour', 'konnichiwa' ]",
            " ",
            "2. Слияние итерируемых объектов. Spread-оператор также может собирать одно значение из нескольких других.",
            " ",
            "      const foo = ['hello', 'bonjour', 'konnichiwa'];",
            "      const bar = ['gutentag', 'hello-ey'];",
            "      const baz = [...foo, ...bar];",
            "      console.log(baz); // ['hello', 'bonjour', 'konnichiwa', 'gutentag', 'hello-ey']",
            " ",
            "3. Также оператор позволяет поместить расширенный массив в другой массив:",
            " ",
            "      const foo = ['hello', 'bonjour', 'konnichiwa']; ",
            "      const bar = [...foo, 'gutentag', 'hello-ey'];",
            "      console.log(bar); // ['hello', 'bonjour', 'konnichiwa', 'gutentag', 'hello-ey']",
            "Помните, что spread-оператор содержит только «материал». Куда вы его положите, решать вам! ",
            " ",
            "4. Ввод аргументов в функции. Эта необходимость возникает не очень часто, но знайте: вы также можете использовать spread-оператор для передачи аргументов в функцию.",
            " ",
            "      const cube = [12, 30, 14] as const; // 'as const' пишем для typescript ",
            "      function calcVolume(width: number, height: number, depth: number) {",
            "            return width * height * depth;",
            "      }; ",
            " ",
            "      console.log(calcVolume(12, 30, 14)); // 5040, базовое использование аргументов ",
            "      console.log(calcVolume(...cube)); // 5040, используем 'spread operator' ",
            " ",
            "Как видно, spread-оператор легко передает функции ряд аргументов. ",
            "-- ",
            "5. Слияние объектных литералов. Что касается объектных литералов, то это очень похоже на слияние массивов:",
            " ",
            "      const foo = { ",
            "            english: 'hello',",
            "            french: 'bonjour',",
            ...
            " ",
            "При слиянии объектов, в которых есть одинаковые ключи, повторяющиеся ключи перезаписываются.",
            " ",
            "6. Spread-оператор и строки. Также spread-оператор можно использовать со строками, поскольку они также считаются итерируемыми объектами (у него есть функции slice и length).",
            " ",
            "      const foo = 'jumanji'; ",
            "      const bar = [...foo]; ",
    ...
    },
    {
        ...
        answer: [
            "Метод preventDefault() предотвращает поведение события по умолчанию.",
    ...
    },
    {
        ...
        answer: [
            "ECMAScript — это язык программирования, используемый в качестве основы для построения других скриптовых языков, например JavaScript. Стандартизирован международной организацией ECMA. ",
            "ECMAScript — это стандартизированная спецификация скриптовых языков программирования, является основой JS. Любые изменения ECMAScript отражаются на JS.",
            " ",
    ...
    },
    {
        ...
        answer: [
            ...
            "(False означает: null, false, undefined, 0, пустую строку, NaN.)",
        ],
        isParagraph: true
    },
    {
    ...
    },
    {
        ...
        answer: [
            "    1. С использованием точки (точечная нотация): obj.property",
            "    2. С использованием квадратных скобок: obj['property']",
            ...
            " ",
            "2. С использованием квадратных скобок: obj['property']. (Обязательно используем кавычки внутри квадратных скобок)",
    ...
    },
    {
        ...
        answer: [
            "SPREAD (…) ",
            "Оператор Spread или синтаксис Spread позволяют нам разложить массивы и объекты на элементы в случае массива и пары ключ-значение в случае объекта. Синтаксис spread в JavaScript представлен тремя точками (...). ",
            "       Синтаксис: let my_variable = [...array];",
            " ",
            "Преимущества использования синтаксиса Spread: ",
            " ",
            "1. Это позволяет нам включать все элементы массива или объекта в список некоторого вида. Он может расширять объект или массив и сохранять все значения в новой переменной того же типа данных. ",
            "2. Это позволяет нам копировать все элементы уже существующего массива в новый массив и выполнять операции push, pop, даже не нарушая предыдущий массив. ",
            "3. Он может объединять строку или два или более массивов без использования функции concat(). ",
            "4. Это позволяет нам оперировать математическими функциями над массивом. Потому что мы не можем использовать математические функции непосредственно в массивах. Оператор spread расширяет массив объектов с возможностью повторения в список аргументов, которые позволяют нам управлять математическими функциями и получать желаемый результат. ",
            "5. Это позволяет нам вносить изменения во вложенный объект без отражения в исходном объекте ",
            " ",
            "Дававйте разберем вариант использования spread-оператора. Для этого достаточно представить, что массив - это контейнер. Spread-оператор позволяет извлечь содержимое контейнера, не прикасаясь к нему. Кроме того, Вы сможете переместить полученное содержимое туда, куда Вам нужно. ",
            "",
            ...
            " ",
            "Теперь массив someOtherAnimals содержит элементы [🦁, 🐘, 🐍, 🦍, 🐯], а массив animals остался неизменным. C помощью spread-оператора мы извлекли элементы массива animals и перенесли их в массив someOtherAnimals.",
            " ",
            "Также spread-оператор можно применять для объединения нескольких массивов в один массив: ",
            " ",
            "            const wild = [🦁, 🐘, 🐍, 🦍, 🐯]; ",
            "            const domestic = [🐐, 🐔, 🐱, 🐶]; ",
            "            const animals = [...wild, ...domestic]; ",
            " ",
            "Теперь массив animals теперь содержит [🦁, 🐘, 🐍, 🦍, 🐯, 🐐, 🐔, 🐱, 🐶], а массив wild и domestic остались неизменными. ",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "REST (…) ",
            "Синтаксис Rest прямо противоположен синтаксису spread: он собирает данные и сохраняет их в переменной, которую мы можем использовать в дальнейшем в нашем коде. ",
            "Оператор Rest: Синтаксис оператора Rest аналогичен синтаксису оператора Spread, где оператор spread расширяет массив на его элементы, с другой стороны, синтаксис rest используется для сбора данных и сохранения этих данных в одной переменной, которую мы можем в дальнейшем передать функции или использовать в нашем коде в качестве переменной. ",
            " ",
            "Синтаксис:  ",
            "      function nameOfFunction(...data: any[]) {",
            "            // function statement ",
            "      } ",
            " ",
    ...
    },
    {
        ...
        answer: [
            "Оператор Spread, как следует из его названия, распространяет или расширяет содержимое данного элемента. ",
            "Синтаксис Rest прямо противоположен синтаксису spread: он собирает данные и сохраняет их в переменной, которую мы можем использовать в дальнейшем в нашем коде. ",
            " ",
            "Оператор Spread расширяет массив в виде элементов, а в случае объектов - в парах ключ-значение.",
            "Синтаксис Rest собирает данные в желаемом разработчиком формате.",
            " ",
            "Оператор Spread перезапишет идентичные свойства внутри двух объектов и заменит первое на второе. ",
            "Синтаксис Rest просто собирает все свойства и помещает их в контейнер. ",
            " ",
            "Оператор Spread. Вы можете использовать или не использовать строгий режим внутри функции, содержащей оператор spread.",
            "Синтаксис Rest. Вы не можете использовать строгий режим внутри функции, содержащей оператор rest ",
            " ",
            "-------------------------------------------------",
            "ИТОГИ ",
            " ",
    ...
    },
    {
        ...
        answer: [
            ...
            "1. Например, когда операция деления / применяется не к числу: ",
            "alert( '6' / '2' ) // 3, строки преобразуются в числа ",
            "-- ",
            "2. Мы можем использовать функцию Number(value), чтобы явно преобразовать value к числу: ",
            "let str = '123' ",
            "alert(typeof str); // string ",
            "let num = Number(str); // Численное преобразование, строка становится числом 123 ",
            "alert(typeof num); // number ",
            "-- ",
            "3. Явное преобразование часто применяется, когда мы ожидаем получить число из строкового контекста, например из текстовых полей форм. Если строка не может быть явно приведена к числу, то результатом преобразования будет NaN. ",
            " - let age = Number('Любая строка вместо числа'); ",
            "alert(age); // NaN, преобразование не удалось ",
            "4. Значение	преобразуется:",
            " - undefined =>	NaN ",
            " - null =>	0 ",
            " - true =>	1 ",
            " - false => 0 ",
    ...
    },
    {
        ...
        answer: [
            ...
            "      console.log( 'prop1' in object ) // false ",
            " ",
            "2. Второй — использовать метод hasOwnProperty:",
            " ",
            "      console.log( object.hasOwnProperty( 'prop2' )) // true ",
            "      console.log( object.hasOwnProperty( 'prop1' )) // false ",
            " ",
            "3. Третий — индексная нотация массива:",
            " ",
            "      console.log( object[ 'prop' ] ) // bwahahah ",
            "      console.log( object[ 'prop1' ] ) // undefined ",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "AJAX — это набор технологий для работы с данными в асинхронном режиме. Это означает, что мы можем отправлять данные на сервер и получать данные с него без перезагрузки веб-страницы.",
            "--",
    ...
    },
    {
        ...
        answer: [
            ...
            "Примеры: ",
            "    -  получение данных с сервера, с базы данных; ",
            "    -  отправка данных в базу данных;",
            "В этих случаях мы ожидаем по времени какого-то результата, а в это время кодвыполняется. Можно нажимать на кнопки и т.д.",
            " ",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            ...
            "Проблема синхронного подхода заключается в том, что иногда мы хотим, например, отправить запрос в API и можем ждать (неизвестно сколько времени), прежде чем получим ответ от сервера. Поскольку мы ждем, функция не завершается, поэтому наш стек вызовов блокируется.",
            "В качестве ответа на этот вызов Web API имеет специальные методы/интерфейсы, которые способны взять под контроль асинхронные операции. Это означает, что пользовательский агент - браузер разблокирует обратный вызов (или промис), чтобы можно было выполнить другие действия.",
            "Затем, когда любые данные возвращаются с сервера, он возвращает ответ в наш callstack",
            "",
        ],
        isParagraph: true
    },
    ...
    },
    {
        ...
        answer: [
            ...
            "      }; ",
            " ",
            "2. Вызываем функцию, методы then() и catch():",
            "      getSomeData() ",
            "            .then((res) => console.log(res))",
            "            .catch((error) => console.log(error)); // some data",
        ],
        isParagraph: true
    },
    {
        heading: "Последовательный вызов промисов; вложенные промисы; ад промисов; цепочка промисов.",
        answer: [
            "1. Создаём функции (методы) с промисами getSomeData(), getAnotherData(), getThirdData(), getFourthData():",
            "      const getSomeData = () => {",
            ...
            "      }; ",
            " ",
            "2. Создаём последовательность промисов, в которой вызов следующего промиса осуществится только после завершения предыдущего. Последующие промисы вложены в предыдущего.",
            "      getSomeData().then((res1) => { ",
            "            console.log(res1);",
            " ",
            "            getAnotherData().then((res2) => {",
            "                  console.log(res2);",
            " ",
            "                  getThirdData().then((res3) => {",
            "                        console.log(res3);",
            " ",
            "                        getFourthData().then((res4) => {",
            "                              console.log(res4);",
            "                        });",
            "                  });",
            "            });",
            "      }); ",
            " ",
            "      // some data - спустя 5 секунд ",
            "      // another data - спустя 5 + 4 секунд ",
            "      // third data - спустя 5 + 4 + 3 секунд ",
            "      // fourth data - спустя 5 + 4 + 3 + 2 секунд ",
            " ",
            "3. Паралельный вызов промисов. Промисы будут вызваны синхронно, почти одновременно, с разницей по времени в милисекунды. В таком же порядке они попадут в подсистему браузера web-api, где начнут работать их таймеры. После отработки таймеров во временной последовательности, задачи промисов попадут в очередь задач. ",
            "      getSomeData().then((res1) => {",
            "            console.log(res1);",
            "      }); ",
            " ",
            ...
            "      }); ",
            " ",
            "      // fourth data - спустя 2 секунды от начала вызовов ",
            "      // third data - спустя 3 секунды от начала вызовов ",
            "      // another data - спустя 4 секунды от начала вызовов ",
            "      // some data - спустя 5 секунды от начала вызовов ",
            " ",
            "4. Цепочка промисов.",
            "      getSomeData() ",
            "            .then((result) => {",
    ...
    {
        heading: "Преобразовать цепочку промисов в async / await ",
        answer: [
            "1. Создаём функции (методы) с промисами getSomeData(), getAnotherData(), getThirdData(), getFourthData():",
            "      const getSomeData = () => {",
            "            cconst promise = new Promise((resolve, rejected) => {",
            "                  setTimeout(() => {",
            "                        resolve('some data');",
            "                  }, 5000);",
            "            });",
            ...
            "      }; ",
            " ",
            "2. Преобразуем цепочку промисов в async / await ",
            "      const foo = async () => { ",
            "            try {",
            "                  let res1 = await getSomeData();",
            "                  console.log(res1);",
            " ",
            "                  let res2 = await getAnotherData();",
            "                  console.log(res2);",
            " ",
            "                  let res3 = await getThirdData();",
            "                  console.log(res3);",
            " ",
            "                  let res4 = await getFourthData();",
            "                  console.log(res4);",
            "            } catch (e) {",
            "                  console.log(e);",
            "            }",
    ...
    {
        heading: "Преобразование промисов в async / await через Promise.all(promises)  ",
        answer: [
            "1. Создаём функции с промисами getSomeData() и getAnotherData() :",
            "      const getSomeData: () => Promise<string> = () => { ",
            ...
            "      }; ",
            " ",
            "      const getAnotherData: () => Promise<string> = () => { ",
            "            const promise: Promise<string> = new Promise((resolve) => {",
            "                  setTimeout(() => {",
            "                        resolve('another');",
            "                  }, 1000);",
            ...
            " ",
            "      const foo = async () => { ",
            "            const res = await Promise.all([getSomeData(), getAnotherData()]);",
            "            console.log(res);",
            "      }; ",
        ],
        isParagraph: true
    ...
    },
    {
        ...
        answer: [
            "1. Промис — это ОБЪЕКТ JavaScript, который занимается обработкой асинхронного кода. Промис представляет результат завершения асинхронной операции: успешный результат или неуспешный. Промисы позволяют откладывать выполнение блоков кода до момента завершения асинхронной операции. ",
            "2. Асинхронная операция - это операция, которая выполняется независимо от внешнего кода, в котором она вызывается, и не блокирует выполнение вызываемого кода.  ",
            "3. Промисы создаются через конструктор Promise, который обязательно вызывается через new.",
            "4. Значение промиса устанавливается один раз, после чего его уже не изменить ",
            "5. В работе мы чаще используем промисы, чем создаём. Использовать промис — значит выполнять код при изменении состояния промиса. Существует три метода, которые позволяют работать с результатом выполнения вычисления внутри промиса:",
            ...
            " ",
            "6.   Для удобства можно использовать статические методы — функции-конструкторы Promise.resolve() и Promise.reject(), которые создают сразу установленный промис. ",
            "6.1. Promise.resolve(). ",
            ...
            "      }); ",
            " ",
            "6.2. Promise.reject(). Обратите внимание, что результатом выполнения sadDog.catch() будет промис в статусе fulfilled. ",
            ...
            "      }); ",
            " ",
            "7. Главное в промисах. Применение промисов даёт несколько преимуществ.",
            "    *  Промисы позволяют обрабатывать отложенные во времени события. Колбэки никогда не будут вызваны до завершения обработки текущего события в событийном цикле JavaScript. ",
            ...
            " ",
            "8. Цепочки методов. Методы then(), catch() и finally() часто объединяют в цепочки вызовов, чтобы обработать успешный и ошибочный сценарии. ",
            "Цепочка промисов – концепция в том, что методы промисов в качестве результата так же возвращают промис. Следовательно для них мы тоже можем вызвать методы промисов и т.д. Таким образом, мы можем создавать цепочку из промисов, каждый из которых выполняется только после того как завершился предыдущий. ",
            " ",
            "9. Промисы схлопываются. ",
            ...
            " ",
            "10. Промис может находиться в одном из трёх состояний:  ",
            "    *  pending — стартовое состояние, операция стартовала;   ",
            "    *  fulfilled — получен результат; ",
            "    *  rejected — ошибка. ",
            " ",
            "11. Промис становится «разрешённым» или «завершённым», когда он переходит из состояние pending в fulfilled или rejected. Состояние завершённого промиса нельзя поменять. ",
            ...
            "🛠 Если нужно дождаться пока несколько асинхронных функций завершатся (без разницы, успешно или ошибкой), используйте метод Promise.allSettled() (вернёт промис). Для пустого массива сразу вернётся пустой результат.",
        ]
    },
    {
        heading: "Статические методы промисов Promise.all(promises)",
        answer: [
            "1. Promise.all(promises) – ожидает выполнения всех промисов и возвращает массив значений или первый отказ. Если любой из указанных промисов вернёт ошибку, то в catch прилетит причина отказа, результаты остальных промисов будут игнорироваться. ",
            ...
            "      }); ",
            " ",
            "      let resultPromises = Promise.all([promise1, promise2]) ",
            "            .then(console.log)",
    ...
    {
        heading: "Статические методы промисов Promise.allSettled(promises)",
        answer: [
            ...
            "// value: 'some data' ",
            " ",
            "// reason: Error: Произошла ошибка ",
            "// status: 'rejected' ",
        ],
        isParagraph: true
    },
    {
        heading: "Статические методы промисов  Promise.race(promises) ",
        answer: [
            ...
            "      }); ",
            " ",
            "      let resultPromises = Promise.race([promise1, promise2]) ",
            "            .then(console.log)",
            "            .catch((e) => console.log(e)); // Произошла ошибка",
            " ",
        ],
        isParagraph: true
    },
    {
        heading: "Статические методы промисов  Promise.any(promises) ",
        answer: [
            ...
            "      }); ",
            " ",
            "      let resultPromises = Promise.any([promise1, promise2]) ",
            "            .then(console.log)",
            "            .catch((e) => console.log(e)); // some data",
            " ",
        ],
        isParagraph: true
    },
    {
        heading: "Статические методы промисов  Promise.resolve(value) ",
        answer: [
            "5. Promise.resolve(value) – возвращает успешно выполнившийся промис с результатом value.",
            "",
            "            const promise1 = Promise.resolve('some data'); ",
            "            promise1.then((value) => { ",
            "                  console.log(value);",
            "            }); ",
            "            //  some data ",
    ...
    {
        heading: "Статические методы промисов Promise.reject(error)  ",
        answer: [
            "6. Promise.reject(error) – возвращает промис с ошибкой error.",
            "            const promise2 = Promise.reject('провал'); ",
    ...
    },
    {
        ...
        answer: [
            "    *  async  перед функцией означает: функция асинхронная и всегда возвращает промис.",
            "    *  await  заставляет JavaScript ждать, пока этот промис не выполнится, и после этого возвращает результат.",
            " ",
            "Async/await - синтаксическая надстройка над промисами, не более. Ключевые слова async/await не вносят в JavaScript что-то новое. Они только упрощают работу с Promise. Это синтаксический сахар, реализованный через промисы, который делает работу с асинхронными операциями более удобной. ",
            " ",
            "    1. Асинхронная функция всегда возвращает Promise. Результат асинхронной функции извлекается через then или через await.",
            "    2. Внутри асинхронных функций можно вызывать другие асинхронные функции, без каких-либо then() или колбэков, с помощью ключевого слова await.",
            "    3. Await синтаксис возможен только внутри async (асинхронных) функций. Await заставляет JavaScript ждать, пока этот промис не выполнится, и после этого возвращает результат.",
            " ",
            "    ** Асинхронная функция ожидает результата инструкции await и не выполняет последующие инструкции. Это очень важно. То есть, если есть инструкция с ключевым словом async, дальше функция не будет выполнятся, пока Promise находится в состоянии pending (ожидания). Но при этом, JavaScript может выполнять другие задачи, например, выполнять какие-то действия при нажатии пользователем какой нибудь кнопки в интерфейсе фронт-энд приложения. То есть, это не блокирующее действие. Промис не блокирует выполнение других частей нашего приложения. И только, когда промис будет resolved или rejected, то есть - либо исполнен, либо отклонён, выполнение функции продолжится. Это главное в ASYNC/AWAIT синтаксисе.",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "      Async/await - синтаксическая надстройка над промисами, не более. ",
            "      Асинхронная функция ожидает результата инструкции await и не выполняет последующие инструкции. Но при этом, JavaScript может выполнять другие задачи. То есть, (await) - ожидание результата выполнения инструкций, нахождение Promise в состоянии pending, это не блокирующее действие. Промис не блокирует выполнение других частей нашего приложения. И только, когда промис будет либо исполнен, либо отклонён, выполнение функции продолжится.",
            "      Это главное в ASYNC/AWAIT синтаксисе.",
        ],
        isParagraph: true
    },
    {
        heading: "Связка async/await. Внутри асинхронных функций можно вызывать другие асинхронные функции.",
        answer: [
    ...
    },
    {
        ...
        answer: [
            "Fetch – это новый API, основанный на промисах. Он позволяет выполнять запросы Ajax (асинхронные JavaScript и XML) с помощью JavaScript и при этом избежать всей работы, связанной с XMLHttpRequest.",
    ...
    },
    {
        ...
        answer: [
            "1. Функция — это самостоятельный блок кода, который можно, один раз объявив, вызывать столько раз, сколько нужно. Функция может принимать параметры (необязательно). Функции возвращают единственное значение. ",
            ...
            " ",
            "2. Способы объявления функций. ",
            " ",
            "2.1. Функции вида 'function declaration statement'. ",
            "Объявление функции состоит из ключевого слова function, наименования функции, параметров и тела функции: ",
            ...
            " ",
            "2.2. Функцию можно назначить переменной или константе. Такая конструкция называется функциональным выражением (function expression).",
            ...
            " ",
            "2.3. Можно заметить, что в вышеприведённом примере функция назначена константе, но сама она имени не имеет. Такие функции называют анонимными. Подобным функциям можно назначать имена. В таком случае речь идёт об именованном функциональном выражении (named function expression).",
            ...
            " ",
            "2.4. Стрелочные функции (arrow function) особенно удобно использовать в виде так называемых «встроенных функций» (inline function) — в роли аргументов, передаваемых другим функциям (коллбэков).",
            "      const doSomething = (foo) => { ",
            "            // сделать что-нибудь",
            "      } ",
            "",
            ...
            "    *  Стрелочные функции не объявляют привязку ('bind') их контекста this.",
    ...
    },
    {
        ...
        answer: [
            ...
            "https://habr.com/ru/companies/ruvds/articles/519654/ ",
            " ",
            "Когда функция детерминированная и не имеет побочных эффектов, мы называем её 'чистой' функцией. Настолько она предсказуема, чиста и прозрачна. В этом смысле чистые функции близки к математическим. x в квадрате с одним и тем же значением x, всегда будет давать одинаковый результат, а вычисление квадрата x не будет менять сам x. Всё, что касается чистых функций кажется 'проще': они просты для чтения, для отладки и поиска ошибок, для тестирования. ",
    ...
    },
    {
        heading: "В чем разница между обычной функцией и функциональным выражением?",
        answer: [
            "1. Функции, созданные как Function Declaration, могут быть вызваны раньше своих определений.  ",
            " ",
            "2. Функции, объявленные при помощи Function Expression, создаются тогда, когда выполнение доходит до них. ",
            "После того, как поток выполнения достигнет правой части выражения присваивания let sum = function… – с этого момента, функция считается созданной и может быть использована (присвоена переменной, вызвана и т.д. ). ",
        ],
        isParagraph: true
    },
    ...
    },
    {
        ...
        answer: [
            ...
            "Call stack - это то место, куда по ходу выполнения кода попадают вызванные функций (по принципу: последний зашёл, первым вышел) после чего выполняются.  ",
        ],
        isParagraph: true
    },
    {
    ...
    },
    {
        ...
        answer: [
            ...
            "К итеративным объектам в JavaScript относятся карты (коллекции Map), массивы и наборы с итерируемым свойством. Простые объекты по умолчанию не являются итеративными. ",
            ...
            "Понятие «итеративный объект» (также итерируемый, перебираемый объект) в информатике на самом деле является просто термином для описания категории типов данных. К таким типам относятся, в частности, массивы, объектные литералы и строки.",
    ...
    },
    {
        ...
        answer: [
            "Map это коллекция пар ключ-значение, где ключ может быть любого типа. Mapзапоминает исходный порядок, в котором элементы были добавлены к нему, что означает, что данные могут быть извлечены в том же порядке, в котором они были вставлены.",
            "Другими словами, Map имеет характеристики обоих Object и Array: ",
            " - Как и объект, он поддерживает структуру пары ключ-значение.",
            " - Подобно массиву, он запоминает порядок вставки.",
            "Новый Map может быть создан следующим образом: ",
            "const map = new Map(); ",
            "Который возвращает пустое Map: ",
            "Map(0) {} ",
            "Другой способ создания Map - использовать начальные значения. Вот как создать Map с тремя парами ключ-значение: ",
            " ",
        ],
        isParagraph: true
    },
    ...
    },
    {
        ...
        answer: [
            "Литерал – это любое значение указанное явным образом в коде. В качестве литералов в js могут выступать числа, строки (текстовые значения), логические значения, функциональные литералы, массивы и объекты. ",
            "Литералы в JavaScript представляют собой фиксированные значения, которые нельзя изменить. Литерал JavaScript может быть числовым, строковым, значением с плавающей запятой, логическим значением или даже объектом.",
            "Литералы часто используются для инициализации переменных в программировании, имена переменных являются строковыми литералами. ",
            "JavaScript поддерживает различные типы литералов, которые перечислены ниже: ",
            " * Числовой литерал ",
    ...
    },
    {
        ...
        answer: [
            "Он содержит десятичную точку(.) ",
            "Дробь - это литерал с плавающей запятой. ",
            "Он может содержать показатель степени. ",
            "Примеры литерала JavaScript с плавающей запятой:",
            "6.99689 // литерал с плавающей запятой, ",
            "-167.39894 // отрицательный литерал с плавающей запятой.",
            " ",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "Логический литерал поддерживает только два значения: true или false.",
            "Пример логического литерала JavaScript: ",
    ...
    },
    {
        ...
        answer: [
            ...
            "Примеры строковых литералов: ‘Привет мир!’, «site=’Study’», 'tonight', ‘123’. ",
            " ",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "\b - представляет собой пробел. ",
            "\f	- представляет собой канал формы. ",
            "\n	- представляет собой новую строку. ",
            "\r - представляет собой возврат каретки. ",
            "\t	- представляет собой вкладку. ",
            "\v	- представляет собой вертикальную вкладку. ",
            "'	- представляет собой апостроф или одинарную кавычку. ",
            '"	- представляет собой двойную кавычку. ',
            "\\	- представляет собой символ обратной косой черты. ",
            "  символ Юникода, заданный четырехзначным шестнадцатеричным числом. ",
            " ",
        ],
        isParagraph: true
    },
    {
        ...
        answer: [
            "Литерал массива - это список из нуля или более выражений, представляющих элементы массива, которые заключены в квадратную скобку ([]).",
            "Всякий раз, когда вы создаете массив с использованием литерала массива, он инициализируется элементами, указанными в квадратной скобке. ",
    ...
    },
    {
        ...
        answer: [
            "Регулярное выражение - это шаблон, используемый для сопоставления символа или строки в некотором тексте. Он создается путем помещения строки регулярного выражения между косыми чертами.",
    ...
    },
    {
        ...
        answer: [
            "Это набор пар ключ-значение, заключенных в фигурные скобки({}). Пара ключ-значение разделяется запятой.",
    ...
    },
    {
        ...
        answer: [
            "Event Loop - собственно сам механизм, который и определяет приоритеты, решает какую задачу куда направить и в какой момент времени.",
            "Цикл событий — это выполнение кода и обновление интерфейса. ",
        ],
        isParagraph: true
    },
    {
    ...
    },
    {
        ...
        answer: [
            ...
            "База рекурсии – это такие аргументы функции, которые делают задачу настолько простой, что решение не требует дальнейших вложенных вызовов. ",
            "Рекурсивно определяемая структура данных – это структура данных, которая может быть определена с использованием самой себя. Например, связанный список может быть определён как структура данных, состоящая из объекта, содержащего ссылку на список (или null). list = {value, next - > list}. ",
            "-*- ",
        ],
        isParagraph: true
    },
    {
        heading: "Операторы ~ и ~~  ",
        answer: [
            "1. Оператор ~ используется для изменения целых чисел (N+1), например: ",
            "            console.log(~2);  // -3 ",
            "            console.log(~1);  // -2 ",
            "            console.log(~0);  // -1 ",
            "            console.log(~-1); // 0 ",
            " ",
            "2. Оператор ~~ используется для округления числа с плавающей запятой в меньшую сторону, аналогичен Math.floor(). Например:",
            "            3.1 становится 3, ",
            "            -1.1 становится -2,",
            "",
            "            console.log(~~2);    //  2 ",
            ...
            "            console.log(~~-3.9); // -3",
            " ",
            "2.1. Самое главное: оператор ~~ приводит [undefined] к нулю:",
            " ",
            "            console.log(~~[undefined]); // 0.",
            " ",
            "2.2. Если вы хотите сделать это с помощью TypeScript, то используйте запись: foo['undefined'].",
            "Ключи:  foo[undefined], foo['undefined'], foo.undefined  указывают на одно и то же свойство.   ",
            " ",
            "Но ключ: console.log(~~obj[undefined]) - невозможно использовать как тип индекса.ts(2538); ",
            " ",
            "А ключ: console.log(~~obj['undefined']) - правильно, кампилятор пропускает эту запись.",
        ],
        isParagraph: true
    },
    {
    ...
    },
    {
        ...
        answer: [
            "1. JavaScript содержит глобальный объект, который является средой его исполняющей системы. ",
            ...
            "Но чаще на него ссылаются по-старому, в браузере он называется window, в Node.js — global, в другой среде исполнения может называться иначе. ",
    ...
    },
    {
        ...
        answer: [
            "JavaScript, помимо глобального объекта, содержит также следующие встроенные объекты:",
            "    *   Array - Массивы",
    ...
    },
    {
        ...
        answer: [
            "1. «Чистая» функция - это функция, которая выводит свои данные основываясь исключительно на свои входные данные и не вызывает побочных эффектов в приложении. Математические функции являются примерами «чистых» функций.",
            "Чистая функция, будучи вызванной с одними и теми же аргументами, возвращает один и тот же результат (и больше ничего не делает) – что довольно приятно. С ней просто работать.",
            ...
            "      } ",
            " ",
            "2. «Нечистые» функции бывают разных форм и размеров. Вот некоторые примеры: ",
            ...
            " ",
            "Пример нечистой функции, которая возвращает разные данные: ",
            "      console.log(Math.random()); // 0.9592094570660801 ",
            "      console.log(Math.random()); // 0.7110956828663455 ",
            "      console.log(Math.random()); // 0.2840752653966403 ",
            "      console.log(Math.random()); // 0.3568223295364972 ",
            " ",
    ...
    {
        heading: "Назовите отличия стрелочной функции от обычной ",
        answer: [
            "В стрелочной функции опускается слово function, и такая функция неявно возвращает значение или результат выражения. ",
            "Стрелочные функции не имеют собственного this. Они копируют значение this из лексического окружения.",
            "Стрелочные функции не имеют доступа к объекту arguments. Получить аргументы можно с помощью оператора rest. ",
        ],
        isParagraph: true
    },
    {
        heading: "Копирование массива.",
        answer: [
            "1. Используя метод Array.slice(): ",
            "Мы используем метод slice для создания мелкой копии массива. Этот метод создает новый массив с подмножеством элементов из исходного массива. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = originalArray.slice(); ",
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "2. Использование оператора spread: ",
            "Использование оператора spread ... - это краткий и простой способ клонирования массива в JavaScript. Оператор spread позволяет вам разложить массив на отдельные элементы, которые затем можно использовать для создания нового массива. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = [...originalArray]; ",
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "3. Используя метод Array.from(): ",
            "Использование метода Array.from() - это еще один способ клонирования массива в JavaScript. Этот метод создает новый массив из существующего массива, используя необязательную функцию сопоставления для преобразования значений в новом массиве. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = Array.from(originalArray); ",
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "4. Используя метод Array.concat(): ",
            "Использование метода Array.concat() - это еще один способ клонирования массива в JavaScript. Этот метод создает новый массив путем объединения двух или более массивов вместе. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = [].concat(originalArray); ",
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "5. Использование цикла for: ",
            "Этот метод включает в себя перебор каждого элемента в исходном массиве и копирование каждого элемента в новый массив. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = []; ",
            " ",
            ...
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "6. Используя метод Array.map(): ",
            "Использование метода Array.map() - это еще один способ клонирования массива в JavaScript. Этот метод создает новый массив путем сопоставления каждого элемента исходного массива с новым значением. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = originalArray.map(x => x); ",
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "7. Использование метода Array.from() с функцией map: ",
            "Использование метода Array.from() с функцией map - это еще один способ клонирования массива в JavaScript. Этот метод создает новый массив путем сопоставления каждого элемента из исходного массива с новым значением с помощью предоставленной функции. ",
            "      const originalArray = [1, 2, 3]; ",
            ...
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "9. Используя метод Object.assign(): ",
            "Использование метода Object.assign() - это еще один способ клонирования массива в JavaScript. Этот метод создает новый массив путем копирования свойств исходного массива в новый объект. ",
            "      const originalArray = [1, 2, 3]; ",
            "      const clonedArray = Object.assign([], originalArray); ",
            "      console.log(clonedArray); // [1, 2, 3] ",
            " ",
            "10. Для глубокого копирования используяем методы JSON.parse() и JSON.stringify(): ",
            "Использование методов JSON.parse() и JSON.stringify() - это еще один способ клонирования массива в JavaScript. Этот метод включает преобразование исходного массива в строку JSON, а затем синтаксический анализ строки JSON для создания нового массива. ",
            "      const originalArray = [ ",
            "            [1, 2, 3], ",
            "            [4, 5, 6], ",
            "      ]; ",
            ...
            " ",
            "11. Используем метод глубокого копирования объектов structuredClone() ",
            "      const originalArray = [ ",
            "            [1, 2, 3], ",
            "            [4, 5, 6], ",
            "      ]; ",
    ...
    {
        heading: "Как распаковать (развернуть) вложеные массивы в один массив.   ",
        answer: [
    ...
    },
    {
        ...
        answer: [
            ...
            " ",
            "      async и defer  - асинхронная загрузка скриптов, они не блокируют отрисовку страницы. Так что пользователь может просмотреть содержимое страницы и ознакомиться с ней сразу же. Но есть и значимые различия:",
            "      <script async> - Порядок загрузки (кто загрузится первым, тот и сработает).",
