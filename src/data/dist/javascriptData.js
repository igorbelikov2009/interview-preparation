...
exports.arrayJavascript = [
    ...
    },
    {
        ...
        answer: [
            ...
            "У этого функции - объекта нет свойства 'hello': ",
            " ",
            "1* function Yo() {",
            ...
            "} ",
            " ",
            "// Через prototype мы добавляем нашей функции - объекту свойство 'hello': ",
            "2* Yo.prototype.hello = function () { ",
            "    alert('hello') ",
            "} ",
            " ",
            "3* var yo = new Yo() ",
    ...
    },
    {
        ...
        answer: [
            "«==» нестрогая проверка на равнество используется для сравнения двух значений независимо от типа данных переменной (сравнивает значения).",
            "«===» строгая проверка на равнество используется для сравнения двух значений, но это будет строгая проверка, поэтому будет проверяться соответствие значения и типа данных (сравнивает как значение, так и тип).",
        ],
        isParagraph: true
    },
    {
