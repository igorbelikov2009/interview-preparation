...
exports.arrayJavascript = [
    ...
    },
    {
        ...
        answer: [
            "Замыкание - это наша функция и её область видимости. И поэтому, все переменные, которые находятся внутри неё, мы можем внутри этой функции вызывать.",
    ...
    },
    {
        ...
        answer: [
            "При всплытии событий, процесс начинается с запуска обработчиков событий на самом внутреннем элементе, потом на его родителе, затем выше и так далее, вверх по цепочке предков, пока событие не достигнет самого внешнего элемента - самого document.",
