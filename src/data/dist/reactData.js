...
exports.linksReactPage = exports.arrayReact = void 0;
exports.arrayReact = [
    {
        ...
        answer: [
            ...
            "    тзьИспользование React для разработки приложений позволяет создавать мощные и производительные интерфейсы, которые отвечают всем современным требованиям к пользованию веб-приложениями.",
        ],
        isParagraph: true
    },
    {
    ...
    // },
    {
        ...
        answer: [
            ...
            "2. Компонент без состояния просто получают данные через пропсы и отображают их без каких-либо манипуляций с данными. Эти компоненты считаются «чистыми», поскольку они связаны только с визуализацией данных и не имеют побочных эффектов. ",
    ...
    },
    {
        ...
        answer: [
            ...
            "    -  вызова анимаций;",
            "    -  для управления фокусом, выбором текста или воспроизведением мультимедиа;",
    ...
    {
        heading: "Что такое Context и для чего он используется?",
        answer: [
            "      React Context - это метод передачи данных от родительского компонента к дочернему компонентам путем хранения данных в хранилище (как в Redux) и использования этих данных из хранилища дочерним компонентом (компонентами) без фактической передачи их вручную на каждом уровне дерева компонентов. ",
            "      Контекст позволяет снабжать дочерние компоненты «глобальными» данными (например, текущий аутентифицированный пользователь, UI-тема или выбранный язык), избегая промежуточные компоненты.",
    ...
    },
    {
        ...
        answer: [
            "      Редюсер — это чистая функция, которая принимает текущие state и action, а затем возвращает новый state приложения. Редюсер отвечает за обработку действий и соответствующее обновление состояния. Он не должен выполнять никаких побочных эффектов, таких как выполнение вызовов API, а вместо этого должен возвращать только следующее состояние. ",
            " ",
    ...
    },
    {
        ...
        answer: [
            ...
            " ",
            "Хуки позволяют нам использовать различные функции React из наших компонентов. Мы можем использовать встроенные хуки или комбинировать их, чтобы создать свои собственные. ",
            " ",
