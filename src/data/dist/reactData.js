...
exports.arrayReact = [
    ...
    {
        heading: "Назовите разницу между управляемыми (контролируемым) и неуправляемыми (неконтролируемым) компонентом (Кратко.......) ",
        answer: [
    ...
    {
        heading: "В чем разница между управляемыми (контролируемым) и неуправляемыми (неконтролируемым) компонентом в React? (Подробно...) ",
        answer: [
    ...
    {
        heading: "Назовите разницу между презентационным (тупой, немой) и контейнерным (интеллектуальный, умный) компонентом?",
        answer: [
    ...
    },
    {
        ...
        answer: [
            ...
            "Моментальная перерисовка элементов вэб страницы. Реакт позволяет перерисовывать только определённые части вэб страницы, при этом отсавляя остальные части без изменения. Для пользователей перерисовка происходит, практически, мгновенно, реагируя на действия пользователей.",
