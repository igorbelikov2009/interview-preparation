...
exports.arrayReact = [
    ...
    {
        heading: "Назовите разницу между контролируемым (управляемым) и неконтролируемым (неуправляемым) компонентом (Кратко.......) ",
        answer: [
    ...
    {
        heading: "В чем разница между контролируемым и неконтролируемым компонентом в React? (Подробно...) ",
        answer: [
    ...
    {
        heading: "В чем разница между управляемыми (контролируемым) и не управляемыми (неконтролируемым) компонентами? (Подробно, с примером...) ",
        answer: [
            ...
            "const NameForm: FC = () => { ",
            " - handleSubmit(event) {",
            " - - alert('Отправленное имя: ' + this.input.current.value); // this??? ",
    ...
    {
        heading: "Flux-архитектура, Redux и MobX: Что такое Flux - архитектура? Какие сущности она имеет?",
        answer: [
