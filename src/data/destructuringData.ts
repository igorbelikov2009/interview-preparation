...
export const linksDestructuring: ILinkInfo[] = [
  {
...
export const arrayDestructuringArrays: IObjectHeadingAnswers[] = [
  {
  ...
  },
  {
    ...
    answer: [
      ...
      " ",
      "Выводим в консоль значения новых переменных: ",
  ...
  },
  {
    ...
    answer: [
      "Значения элементов массива копируем в переменные:",
  ...
  {
    heading:
      "Деструктуризации массива с использованием переменной 'оператора остатка' остальной части литерала массива ",
    answer: [
      "Имеем массив: ",
      "      const profile = ['Oluwatobi', 'Sofela', 'codesweetly.com']; ",
      " ",
  ...
  },
  {
    ...
    answer: [
      ...
      " ",
      "1. В деструктурирующем массиве задаём значения по умолчанию: ",
      ...
      " ",
      "2. В деструктурирующем массиве задаём значения по умолчанию: ",
      "      const [firstName = 'Tobi', lastName = 'Sofela', website = 'CodeSweetly'] = ['Oluwatobi'];",
      " ",
      "Выводим в консоль значения переменных: ",
      "      console.log(firstName);   // Oluwatobi ",
      "      console.log(lastName);   // Sofela",
      "      console.log(website);      // CodeSweetly",
      " ",
      "В коде выше мы задали 'Tobi', 'Sofela' и 'CodeSweetly' в качестве значений по умолчанию для переменных firstName, lastName и website. ",
      "Поэтому при попытке извлечь значения с индексом 1 из массива, указанного в правой части, компьютер по умолчанию выводит 'Sofela',  а с индексом 2 компьютер по умолчанию выводит 'CodeSweetly', поскольку в массиве [ 'Oluwatobi' ] существует значение только с нулевым индексом. ",
    ],
    isParagraph: true,
  },
  {
  ...
  },
  {
    ...
    answer: [
      ...
      "      function getUserBio([firstName, lastName]: string[]) {",
      "            return `My name is ${firstName} ${lastName}`",
      "      }",
      " ",
      "Вызываем getUserBio() и передаём массив profile в качестве аргумента:",
  ...
  {
    heading:
      "Рассмотрим еще один пример использования деструктуризации массива для извлечения значений из массива в параметры функции.",
    answer: [
      ...
      " ",
      "1. Определяем функцию с двумя деструктурирующими массивами, каждый из которых содержит параметр:",
      "      function getUserBio([website, , [userName]]: (string | string[])[]) {",
      "            return `${userName} runs ${website}`;",
      "      }",
      " ",
      "Вызываем getUserBio() при передаче массива profile в качестве аргумента:",
      ...
      " ",
      "2. Определяем функцию с двумя деструктурирующими массивами, каждый из которых содержит параметр:",
      "      function getUserBio([website, , [firsName, lastName]]: (string | string[])[]) {",
      "            return `${firsName} ${lastName} runs ${website}`;",
      "      }",
      " ",
      "Вызываем getUserBio() при передаче массива profile в качестве аргумента:",
      "      console.log(getUserBio(profile)); // Oluwatobi Sofela runs codesweetly.com",
      " ",
      "В кодах выше мы разные вложенные массивы: в 1-ой функции [userName], во 2-ой - [firsName, lastName] ",
    ],
    isParagraph: true,
  },
  {
    ...
    answer: [
      ...
      "",
      "      getUserBio();      // Получим ошибку: ожидалось аргументов: 1, получено: 0. ts(2554).",
      "                                // Не указан аргумент, соответствующий этому шаблону привязки.  ",
      " ",
      ...
      "      function getUserBio([firstName]: string[] = []) {",
      "            console.log('Сделайте что-нибудь еще, для чего не нужен параметр деструктурирования') ",
      "            return `My name is ${firstName}.`",
      "      }",
      " ",
      ...
      "      getUserBio(); // Сделайте что-нибудь еще, для чего не нужен параметр деструктурирования",
...
export const arrayDestructuringObjects: IObjectHeadingAnswers[] = [
  {
  ...
  },
  {
    ...
    answer: [
      "Обратите внимание, что в приведенном выше коде было показано, как присвоить значение из объекта переменной в случае, когда свойство объекта и переменная имеют одинаковые имена. Однако можно присвоить значение свойства и переменной с другим именем. Давайте посмотрим как. ",
      " ",
      "1. Определяем объект: ",
      "",
      "      const profile = { ",
      ...
      "В приведенном выше коде компьютер успешно извлек значение из объекта profile в переменную с именем surname, несмотря на то что свойство и переменная имеют разные имена. ",
      " ",
      "3. Примечание, выражение:  ",
      "      const { ",
      "            lastName: { familyName: surname },",
      "      } = profile; ",
      "",
      ...
      "",
      "      const surname = profile.lastName.familyName  ",
    ],
    isParagraph: true,
  },
  {
  ...
  },
  {
    ...
    answer: [
      ...
      "      let website = 'CodeSweetly'; ",
      " ",
      "Используем прямую деструктуризацию объекта: ",
  ...
  },
  {
    ...
    answer: [
      ...
      "      function getUserBio({ firstName, lastName }: Profile) {",
      "            return `My name is ${firstName} ${lastName}.`; ",
      "      } ",
      " ",
  ...
  {
    heading: "Рассмотрим еще один пример деструктуризации объекта: ",
    answer: [
      "Определяем type объекта: ",
      "      type Profile = { ",
      "            website: string;",
      ...
      "      function getUserBio({ website, fullName: { firstName: userName } }: Profile) {",
      "            return `${userName} runs ${website}`;",
      "      } ",
      " ",
      "Вызываем getUserBio, в качестве аргумента передаём объект profile: ",
  ...
  },
  {
    ...
    answer: [
      "      function getUserBio({ firstName } = {} as any) {",
      "            console.log('Сделайте что-нибудь еще, для чего не нужен параметр деструктурирования'); ",
      "            return `My name is ${firstName}.`;",
      "      }",
      " ",
