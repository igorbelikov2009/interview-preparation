...
var DestructuringPage = function () {
    ...
    var arrayDestructuringArrays = destructuringArraysAPI_1.destructuringArraysAPI.useGetDestructuringArrayQuery().data;
    var arrayDestructuringObjects = destructuringObjectsAPI_1.destructuringObjectsAPI.useGetDestructuringObjectsQuery().data;
    return (react_1["default"].createElement(framer_motion_1.motion.div, { initial: { width: 0, opacity: 0 }, animate: { width: "100%", opacity: 1 }, exit: { x: window.innerWidth, transition: { duration: 0.1 }, opacity: 0 } },
        ...
        arrayDestructuringArrays && (react_1["default"].createElement(Page_1["default"], { title: "\u0412\u043E\u043F\u0440\u043E\u0441\u044B \u043F\u043E \u0434\u0435\u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u0438\u0437\u0430\u0446\u0438\u0438 \u043C\u0430\u0441\u0441\u0438\u0432\u043E\u0432", ArrayHeadingAnswers: arrayDestructuringArrays })),
        arrayDestructuringObjects && (react_1["default"].createElement(Page_1["default"], { title: "\u0412\u043E\u043F\u0440\u043E\u0441\u044B \u043F\u043E \u0434\u0435\u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u0438\u0437\u0430\u0446\u0438\u0438 \u043E\u0431\u044A\u0435\u043A\u0442\u043E\u0432", ArrayHeadingAnswers: arrayDestructuringObjects }))));
};
